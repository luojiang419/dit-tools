...
private:
    ...
    bool migrateToVersion7(QSqlDatabase &db, QString *errorMessage) const;
    ...
    bool ensureAssetParentPathSchemaCompatibility(QSqlDatabase &db, QString *errorMessage) const;
    bool migrateToVersion11(QSqlDatabase &db, QString *errorMessage) const;
